...
import Logo from '../logo/ItWattsLogo.vue';
import LogoIcon from '../logo/LogoIcon.vue';
import RtlLogo from '../logo/RtlLogo.vue';
// dropdown imports
import LanguageDD from '../vertical-header/ItWattsLanguageDD.vue';
import NotificationDD from '../vertical-header/NotificationDD.vue';
import ProfileDD from '../vertical-header/ItWattsProfileDD.vue';
    ...
    <v-app-bar elevation="10" :priority="priority" height="64" class="horizontal-header" color="primary">
        <div :class="customizer.boxed ? 'maxWidth v-toolbar__content px-lg-0 px-4' : 'v-toolbar__content px-6'">
            ...
            <div class="ml-3 ">
              ...
              <v-btn v-if="!useUserProfile().first_name"style="background-color: rgba(var(--v-theme-lightprimary), 0.1) "
                class="custom-hover-primary" size="large" flat href="/itwatts/signin">
                <span class="text-white font-weight-semibold">Sign in</span></v-btn>                            
