    ...
    children: [
        {
            name: 'FrontPage',
            path: '/',
            component: () => import('@/views/itwatts/front-pages/Home.vue')
        },
        {
            name: 'FERA',
            path: '/fera',
            component: () => import('@/views/itwatts/front-pages/FERA.vue')
        },
        {
            name: 'About Us',
            path: '/about-us',
            component: () => import('@/views/itwatts/front-pages/AboutUs.vue')
        },
        {
            name: 'Contact',
            path: '/contact-us',
            component: () => import('@/views/itwatts/front-pages/ContactUs.vue')
        },
        {
            name: 'Packages',
            path: '/packages',
            component: () => import('@/views/itwatts/front-pages/Packages.vue')
        },
        {
            name: 'Portfolio',
