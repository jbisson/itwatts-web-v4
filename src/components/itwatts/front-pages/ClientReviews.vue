...
const userReviewFrront: UserReviewTypes[] = [
    {
        img: review1,
        title: 'Hugues Joannis',
        subtitle: 'Team Manager for 5.W.4.T',
        review: 'ITWatts has simplified the way we manage our virtual team, we used to spend soo much time with excel spreadsheets!'
    },
    {
        img: review2,
        title: 'Jonathan Bisson',
        subtitle: 'Canadian Athlete',
        review: 'One thing I really like about ITWatts is the amount of data I can check and analyse, especially on my power progression!'
    },
        {
        img: review2,
        title: 'Jonathan Bisson',
...
<template>
    <div class="pt-96 pb-lg-14 pb-10 bg-surface testimonials">
        <v-container class="max-width-1218 position-relative" >
            <v-row>
                <v-col cols="12" lg="5">
                    <h2 class="display-1 textPrimary font-weight-semibold">Words from users.</h2>
                    <p class="text-textPrimary opacity-80 py-4 text-17 lh-32 pe-lg-4 font-weight-medium">From athletes to team managers.</p>
                ...
                <v-col cols="12" lg="7">
                    <carousel :itemsToShow="1" :wrapAround="true" :transition="500" class="" :current-slide="currentSlide">
                        <slide v-for="(card, index) in userReviewFrront" :key="card.img">
                            <v-card elevation="0">
                                <div class="text-left">
                                    <p class="text-24 textPrimary clamped-text mb-6">{{ card.review }}</p>
                                    <div class="d-flex ga-4 align-center justify-space-between rtl-reviews pt-4">
                                        <div class="d-flex ga-4 align-center">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-15 text-textPrimary opacity-80">{{ card.subtitle }}</p>
                                            </div>
                                        </div>
