...
const profileDD: profileType[] = [
    {        
        title: i18n.global.t('userProfile.myProfile'),
        //subtitle: i18n.global.t('userProfile.accountSettings'),
        href: '',
        //href: `/itwatts/user/profile/${useUserProfile().user_id}`
        badge: false
    },
];
...
const languageDD: languageType[] = [
    { title: 'English', subtext: '', value: 'en', avatar: en },
    { title: 'Français', subtext: '', value: 'fr', avatar: fr },
];
